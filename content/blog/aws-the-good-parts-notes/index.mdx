...
I successfully landed my first ever paid gig 🎉 this year, where I was responsible for styling a Web app. The project was using React on the front-end and the backend was powered by AWS Amplify and DynamoDB.
