---
title: Tailwind The Future Of CSS
type: "Tutorial"
date: "2019-05-21"
categories: ["CSS", "Notes"]
description: "An introduction to Tailwindcss, a utility-first CSS framework for rapidly building custom designs."
published: true
---
...
Here's the talk [link](https://egghead.io/lessons/tailwind-egghead-talks-tailwind-the-future-of-css-is-here-amadou-sall) 📹

<Callout variant="info">
  These notes were originally published at{" "}
  <a href="https://github.com/eggheadio-projects/tailwind-egghead-talks-tailwind-the-future-of-css-is-here-amadou-sall">
    this repository
  </a>
...
```html
<div class="p-16">
  <button class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-pink-500">
    My Button
  </button>
</div>
```
